...
export default function Navbar() {
    ...
    <div {...props}>
      <Link href='/about' scroll={false}>
        <a
          ...
          className={`text-carbon-700 dark:text-carbon-300 ${
            router.asPath === '/about'
  ...
  const SocialButtons = (props: React.HTMLProps<HTMLDivElement>) => (
    <div className='flex flex-row items-center justify-center space-x-4' {...props}>
      <a href='https://www.instagram.com/freshgiammi' className='font-normal text-carbon-600 dark:text-carbon-300'>
        <svg
      ...
      <a href='https://github.com/freshgiammi' className='font-normal text-carbon-600 dark:text-carbon-300'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          fill='currentColor'
      ...
      <a
        ...
        className='font-normal text-carbon-600 dark:text-carbon-300'
      >
        <svg
          xmlns='http://www.w3.org/2000/svg'
          fill='currentColor'
      ...
      >
        ...
        <div className='z-10 flex flex-col' style={{}}>
          <Link href='/' scroll={false}>
            ...
            >
              <h1 className='text-xl font-semibold text-carbon-900 dark:text-carbon-100'>freshgiammi</h1>
              <p className='text-base font-light text-carbon-900 dark:text-carbon-100'>Fullstack developer</p>
            </a>
          </Link>
        </div>
        ...
        <div className={`ham z-10 block md:hidden ${burgerState ? 'active' : ''}`}>
          ...
          >
            <path
              className='top stroke-carbon-900 dark:stroke-carbon-100'
              d='m 30,33 h 40 c 0,0 9.044436,-0.654587 9.044436,-8.508902 0,-7.854315 -8.024349,-11.958003 -14.89975,-10.85914 -6.875401,1.098863 -13.637059,4.171617 -13.637059,16.368042 v 40'
            />
            <path className='middle stroke-carbon-900 dark:stroke-carbon-100' d='m 30,50 h 40' />
            <path
              className='bottom stroke-carbon-900 dark:stroke-carbon-100'
