...
const Home: NextPage = () => {
  ...
  const highlightedSlideIn: Variants = {
    hidden: { backgroundSize: '0% 50%', transition: { delay: 1, duration: 2, ease: 'easeInOut' } },
  ...
  const heroAnim: Variants = {
    hidden: { opacity: 0, y: 100, transition: { duration: 1, ease: 'easeInOut' } },
    show: { opacity: 1, y: 0, transition: { duration: 1, ease: 'easeInOut' } },
  };

  const dividerAnim: Variants = {
    hidden: { opacity: 0, width: 0, transition: { duration: 2, ease: 'easeInOut' } },
  ...
  return (
    <LayoutBlock className='overflow-hidden'>
      ...
      <motion.section className='flex-center-column hero-full'>
        ...
        text-carbon-800 dark:text-zinc-100 md:px-32 md:text-7xl'
        >
          <motion.div
            variants={heroTopAnim}
            className='z-10 col-[1_/_13] row-end-1 space-y-3 self-center px-4 lg:col-[1_/_8]'
            style={{ y, x }}
          >
            <motion.div variants={heroAnim} className='flex-center-row'>
      ...
      <motion.section className='section-common'>
        ...
        text-4xl font-medium tracking-tight text-carbon-800 dark:text-zinc-100 
        md:text-6xl lg:text-7xl xl:px-20'
        >
