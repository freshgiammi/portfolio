 ...
 */
const AnimatedWave = ({ customVariants, strokeStyle, duration = 3, stagger = 0.1, ...props }: AnimatedWaveProps) => {
  ...
  return (
    ...
    >
      <motion.g
        {...animationConfig}
        className={strokeStyle || 'stroke-zinc-500 dark:stroke-zinc-500'}
        strokeWidth='2'
        strokeLinecap='round'
      >
        <motion.path
          ...
          variants={customVariants || defaultAnimation}
        />
        /0[
        <motion.path
