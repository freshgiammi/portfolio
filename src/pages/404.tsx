...
export default function Custom404() {
  return (
    <section className='flex-center-column h-full space-y-4 bg-zinc-100 dark:bg-zinc-900'>
      <svg
      ...
      <h1 className='text-center text-3xl font-bold text-zinc-800 dark:text-zinc-100 md:text-4xl'>
        {"Whoops, it looks like there's nothing here."}
        <br />
      </h1>
      <h1 className='text-center text-xl text-zinc-800 dark:text-zinc-300 md:text-2xl'>
