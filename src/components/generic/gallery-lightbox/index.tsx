...
// Multi-image counterpart to `Lightbox` (@/components/generic/lightbox): same Dialog
// primitives, but with prev/next navigation and drag-to-swipe between images.
export function GalleryLightbox({ open, onOpenChange, images, initialIndex = 0 }: GalleryLightboxProps) {
        ...
        <Dialog.Popup
          ...
          {image && (
            <motion.div
              ...
              <Image src={image.src} alt={image.alt ?? ""} layout="fullWidth" className={styles.Image} draggable={false} />
            </motion.div>
          )}
